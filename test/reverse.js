    ...
    test('setting object property in array with nested id', (_) => {
        assert.deepEqual(
            reverse([
                {
                    op: 'add',
                    path: '/names/[12345-67890]/cards/[000]',
                    value: { id: 456, name: 'henry' },
                },
            ]),
            [
                {
                    op: 'remove',
                    path: '/names/[12345-67890]/cards/[456]',
                    _prev: { id: 456, name: 'henry' },
                },
            ]
        );
